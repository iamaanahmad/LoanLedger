...
<body>
  ...
  <div class="content">
    ...
    <div class="checks">
      ...
      <div class="check-item check-pass">✓ KYC Verification - Passed</div>
      <div class="check-item check-pass">✓ AML Screening - Passed</div>
      <div class="check-item check-pass">✓ Credit Limit Assessment - Passed</div>
      <div class="check-item check-pass">✓ Documentation Review - Passed</div>
      <div class="check-item check-pass">✓ Risk Threshold Check - Passed</div>
      ${loan.isGreen ? '<div class="check-item check-pass">✓ ESG Compliance - Verified Green Loan</div>' : ''}
    </div>
          ...
          {compliantLoans.slice(0, 4).map((loan) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-slate-500">{loan.id} • {loan.riskRating} Rating</p>
              </div>
              <div className="flex items-center gap-2">
